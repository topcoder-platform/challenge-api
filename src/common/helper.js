...
async function createSelfServiceProject (name, description, type, token) {
  ...
  const phaseObj = {
    ...
    status: 'active' // This 'active' status is used by challenge-forum-processor to create forum for self-service project by the emission of 'challenge.notification.create' event
  }
